...
/**
 * CallHistoryTimeline — vertical timeline of all status/notes updates.
 * Shown in the lead detail panel.
 */
export default function CallHistoryTimeline({ history }) {
  ...
  return (
    <div className="space-y-0">
      {sorted.map((entry, i) => {
        const badgeCls = STATUS_BADGE_CLASSES[entry.status] || 'bg-gray-100 text-gray-500 ring-gray-200';
        ...
        return (
          <div key={i} className="flex gap-3">
            ...
            <div className="flex flex-col items-center w-6 flex-shrink-0">
              <div className={`w-2 h-2 rounded-full mt-1 flex-shrink-0 ${i === 0 ? 'bg-blue-500' : 'bg-gray-300'}`} />
