/**
 * OcrProgressBar — animated progress bar shown during Tesseract processing.
 */
    ...
    <div className="bg-white rounded-2xl border border-blue-100 p-6 text-center space-y-4">
      ...
      <div className="flex justify-center">
        <div className="relative w-14 h-14">
          ...
          <svg className="w-14 h-14 text-blue-500 absolute inset-0 animate-spin" viewBox="0 0 56 56" fill="none"
