  ...
  return (
    <div
      ...
      className={`relative border-2 border-dashed rounded-2xl
        ...
        cursor-pointer transition-all select-none touch-manipulation
        p-8 sm:p-10
        ${dragOver
    ...
    >
      ...
      <div className="text-center">
        ...
        <p className="text-xs text-gray-400 mt-1">
          Tap to browse, drag & drop, or{' '}
          <kbd className="bg-gray-100 border border-gray-200 rounded px-1.5 py-0.5
      ...
      <div className="flex gap-2 flex-wrap justify-center">
        {['Contact card','WhatsApp','Ad image','Multi contacts'].map((t) => (
          <span key={t}
            className="text-xs bg-white border border-gray-200 rounded-full px-2.5 py-1 text-gray-500">
            {t}
          </span>
        ))}
      </div>
